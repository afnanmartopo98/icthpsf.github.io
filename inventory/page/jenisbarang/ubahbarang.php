            ...
            <div class="card-body">
              <div class="table-responsive">
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                <input type="text" name="jenis_barang" value="<?php echo $tampil['jenis_barang']; ?>" class="form-control"  id="jenis_barang"/>
                            ...
                            if (isset($_POST['simpan'])) {
                                ...
                                $sql = $koneksi->query("UPDATE `jenis_barang` SET `jenis_barang` = '$jenis_barang' WHERE `jenis_barang`.`id` = '$id' "); 
